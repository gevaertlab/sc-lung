...
####
def xentropy_loss(true, pred, class_weights = None, reduction="mean"):
    ...
    if class_weights is not None:
        #print(f'calculating weighted loss: {class_weights}')
        loss = -torch.sum((true * torch.log(pred)) * class_weights, -1, keepdim=True)
    else:
